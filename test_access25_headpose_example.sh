...
rsync --delete -azvv /var/lib/docker/volumes/access25_headpose_volume/_data/conda/envs/access25/lib/python3.10/site-packages/images_framework/output/images/ output
