...
sudo docker exec -w /home/username/access25_headpose access25_headpose_container python test/access25_headpose_test.py --input-data test/example.tif --database aflw --gpu 0 --backbone efficientnet --save-image
echo 'Transferring data from docker container to your local machine ...'
mkdir -p output
sudo docker cp access25_headpose_container:/home/username/conda/envs/access25/lib/python3.10/site-packages/pcr_framework/output/images/. output/
